...
export function useParkSearch() {
    ...
    async function searchParks(query: string,
        ...
        try {
            const url = `https://nominatim.openstreetmap.org/search?q=${encodeURIComponent(searchQuery)}&format=json&addressdetails=1&countrycodes=${countryCode}&limit=15`
